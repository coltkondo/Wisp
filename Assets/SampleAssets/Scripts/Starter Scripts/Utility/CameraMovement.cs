...
public class CameraMovement : MonoBehaviour
{
	...
	private Camera cam;//This is the camera we using, it's gonna be handled in start
	...
	void Update()
	{
		...
		Transform camerATransform = cam.gameObject.transform;//We now are gonna check to see if the camera is within it's bounds
